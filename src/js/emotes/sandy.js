const sandy = {
  head: {
    droop: require("@/emotes/sandy/sandy_head_droop.png"),
    normal: require("@/emotes/sandy/sandy_head_normal.png"),
    perked: require("@/emotes/sandy/sandy_head_perked.png"),
    puzzled: require("@/emotes/sandy/sandy_head_puzzled.png"),
  },
  eyebrow: {
    angry: require("@/emotes/sandy/sandy_eyebrow_angry.png"),
    normal: require("@/emotes/sandy/sandy_eyebrow_normal.png"),
    puzzled: require("@/emotes/sandy/sandy_eyebrow_puzzled.png"),
  ...
  eyes: {
    ...
    shocked: require("@/emotes/sandy/sandy_eyes_shocked.png"),
