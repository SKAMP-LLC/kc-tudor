...
document.addEventListener("DOMContentLoaded", () => {
  Promise.all([
    ...
    makeEmoji("kona_worried", "kona", "normal", "normal", "glee", "pout"),
    ...
    makeEmoji("maxine_worried", "maxine", "normal", "normal", "lookaway", "serious"),
    ...
    makeEmoji("sandy_inquisitive", "sandy", "puzzled", "puzzled", "normal", "formal"),
